 ...
 */
	if (tree == 0)
	{
		...
		cout << "Duplicates: " << bs_info.duplicate << endl;
	}
	else
	{
		//rb.output();

		cout << "Case 1: " << rb_info.case_1 << endl;
		cout << "Case 2: " << rb_info.case_2 << endl;
		cout << "Case 3: " << rb_info.case_3 << endl;
		cout << "Left Rotate: " << rb_info.left_rotate << endl;
		cout << "Right Rotate: " << rb_info.right_rotate << endl;
		cout << "Duplicates: " << rb_info.duplicate << endl;
	}
